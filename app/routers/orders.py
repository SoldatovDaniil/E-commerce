...
from app.database.db_services import load_order_with_items, get_cart_items
...
async def checkout_order(
    ...
    """
    Создаёт заказ, очищает корзину
    """
    cart_items: list[CartItemModel] = await get_cart_items(current_user.id, db)
